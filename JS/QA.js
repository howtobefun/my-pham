  ...
  return `
    <div class="product-card" onclick="window.location.href='detail.html?img=${encodeURIComponent(p.id)}'">
      ...
      <div style="display:flex; gap:8px; margin-top:8px;">
        <button class="btn-primary" onclick="event.stopPropagation(); addToCartById('${escapeAttr(p.id)}')">Thêm vào giỏ</button>
    ...
    box.innerHTML = `
      ...
      <div class="detail-info">
        ...
        <div class="detail-actions">
          <button class="btn-primary" onclick="addToCartById('${escapeAttr(found.id)}')">Thêm vào giỏ</button>
